   ...
   <section class="flex max-h-full flex-col justify-between">
      ...
      <div class="flex-1 px-10 pb-24">
         ...
         <div class="mb-6">
            <div class="relative">
               <PhMagnifyingGlass
                  class="absolute left-3 top-1/2 -translate-y-1/2 text-pirate-300"
                  :size="20"
               />
               <input
                  v-model="searchQuery"
            ...
            <button
               ...
               :class="
                  selectedCategory === category.key
                     ? 'bg-resin-500 text-white'
                     : 'bg-gray-100 text-pirate-600 hover:bg-gray-200'
               "
         ...
         <!-- Contact Support -->
         <div
            class="mt-8 rounded-lg border border-gray-200 bg-gray-50 p-4 text-center"
         >
            <p class="text-sm text-pirate-600">
               {{ $t("help.cantFind") }}
               <a
                  href="mailto:support@resin.estate"
