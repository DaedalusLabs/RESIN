   ...
   <div class="mx-auto max-w-2xl p-4">
      ...
      <div class="mb-8 flex items-center justify-between">
         ...
         <div class="text-right">
            ...
            <div
               v-if="method === 'bitcoin' && btcAddress?.destination"
               class="text-gray-600"
            >
               ≈ {{ btcAmount }} BTC
            </div>
      ...
      >
         <div class="flex items-center justify-between">
            <div class="flex items-center gap-2">
               <PhTimer class="h-5 w-5 text-green-600" />
         ...
         <div class="mt-2 h-2 rounded-full bg-green-100">
            <div
      ...
      <template v-if="method === 'bitcoin'">
         <div class="mb-6">
            <div class="mb-6 flex justify-center space-x-2">
               <button
                  v-for="network in ['on-chain', 'lightning', 'liquid']"
                  :key="network"
                  :class="[
            ...
            <div class="text-center">
               <a
                  ...
                  class="mb-4 inline-block h-auto w-auto rounded-lg bg-white p-4 shadow-md transition-shadow hover:shadow-lg"
               >
                  <QRCode
                     :data="getQRData"
                     :image="getQRImage"
               ...
               <div
                  ref="btcAddressContainer"
                  class="mb-4 flex items-center justify-between rounded-lg bg-gray-100 p-3"
               >
                  ...
                  <button
                     class="ml-3 flex-shrink-0 text-resin-500 hover:text-resin-600"
      ...
      <template v-if="method === 'usdt'">
         <div class="mb-6 text-center">
            ...
            <div
               ref="usdtAddressContainer"
               class="mb-4 flex items-center justify-between rounded-lg bg-gray-100 p-3"
            >
               <code class="font-mono text-sm">
                  {{
                     truncateIfNeeded(
                        usdtAddress?.destination || "",
      ...
      <template v-if="method === 'bank'">
         <div class="mb-6 space-y-4">
            ...
            <div v-if="bankDetailsData.currency === 'EUR'" class="text-center">
               <div
                  class="mb-4 inline-block h-auto w-auto rounded-lg bg-white p-4 shadow-md"
               >
                  <QRCode
                     :data="getQRData"
                     :image="getQRImage"
...
const checkInvoiceStatus = () => {
   ...
   fetch(
      `${runtimeConfig.public.BACKEND_ENDPOINT}/payment/invoice/${route.query.id}`,
   )
      .then((res) => res.json())
      .then((data) => {
...
onMounted(() => {
   if (method.value !== "bank") {
      if (method.value === "bitcoin" || method.value === "usdt") {
         fetch(
            `${runtimeConfig.public.BACKEND_ENDPOINT}/payment/details/${route.query.id}`,
         )
            .then((res) => res.json())
            .then((data) => {
