<template>
   <div v-if="property.additional_details" class="mt-12 w-3/4">
      <h2 class="mb-3 text-lg font-bold">
         {{ $t("property.details.additional.title") }}
      </h2>
...
const formatValue = (value) => {
   ...
   if (typeof value === "boolean") {
      return value
         ? t("property.details.additional.yes")
         : t("property.details.additional.no");
   }
   return String(value);
};
</script>
