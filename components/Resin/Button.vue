<template>
   <button
      ...
      :class="[
         ...
         {
            // Variants
            'bg-resin-500 text-white hover:bg-resin-600':
               variant === 'primary' && !disabled,
            'border border-resin-500 bg-transparent text-resin-500 hover:bg-resin-500 hover:text-white':
               variant === 'outline' && !disabled,
            'border border-pirate-400 text-white hover:bg-white hover:text-resin-500':
               variant === 'secondary' && !disabled,
            'bg-white bg-opacity-25 text-pirate-300 hover:cursor-not-allowed':
               disabled,
